...
//Answer: If the value won't change, use const. 

/*---------------------------------- Template Literals -------------------------------------*/
console.log(food, drink, person1, person2);
...
//Answer: Can't re-assign a const
...
const lunchTime = (foodChoice, drinkChoice) => `${person1} is having ${foodChoice} and ${drinkChoice}. ${person2} is just having ${drinkChoice}.`
...
//return (`${person1} is having ${foodChoice} and ${drinkChoice}. ${person2} is just having ${drinkChoice}.`)
//console.log(lunchTime('Pizza','Water'))
//}
...
console.log(foodForTodayAndTomorrow("pizza", "coke", lunchTime('salad', 'apple juice.')))
